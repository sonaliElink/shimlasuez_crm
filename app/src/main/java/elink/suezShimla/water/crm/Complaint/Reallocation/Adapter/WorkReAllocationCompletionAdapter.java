...
public class WorkReAllocationCompletionAdapter extends RecyclerView.Adapter<WorkReAllocationCompletionAdapter.MyViewHolder> {
    ...
    public WorkReAllocationCompletionAdapter(Context mCon, String searchFor, String fromDate, String toDate, String clickStr) {
        this.mCon = mCon;
    ...
    @NonNull
    @Override
    public WorkReAllocationCompletionAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = inflater.inflate(R.layout.row_work_re_allocation_completion, viewGroup, false);
        return new WorkReAllocationCompletionAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull WorkReAllocationCompletionAdapter.MyViewHolder holder, int position) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView complaintNumberTextView, consumerNoTextView, complaintWorkAlloDateTimeTextView, complaintDateTimeTextView, complaintSubTypeTextView,
                consumerNameTextView, complaintByTextView,contactNoTextView, consumerAddressTextView,vipTextView,srNoTextView,originTextView;
