package elink.suezShimla.water.crm.NoConsumerComplaint.NCMapScreen;
...
public class NCMapActivity extends FragmentActivity implements OnMapReadyCallback,
...
public void onStop() {
    ...
    private void checkLocationSettings() {
        ...
        mSettingsClient = LocationServices.getSettingsClient(NCMapActivity.this);
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                try {
                                    ...
                                    rae.startResolutionForResult(NCMapActivity.this, REQUEST_CHECK_SETTINGS);
            ...
            if (locationList.size() > 0) {
                ...
                if (isLatLongModelExist != null) {
                    ...
                    for (LatLongModel LatLongModel : LatLongModelList) {
                        getLocation(LatLongModel.getLat(), LatLongModel.getLon(), LatLongModel.getTitle());
                    }
                } else {
