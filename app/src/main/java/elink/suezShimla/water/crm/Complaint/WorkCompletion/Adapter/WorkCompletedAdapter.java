...
public class WorkCompletedAdapter extends RecyclerView.Adapter<WorkCompletedAdapter.MyViewHolder> {
    ...
    public WorkCompletedAdapter(Context mCon, String searchFor, String fromDate, String toDate, String clickStr) {
        this.mCon = mCon;
    ...
    @NonNull
    @Override
    public WorkCompletedAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = inflater.inflate(R.layout.row_work_completion, viewGroup, false);
        return new WorkCompletedAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull WorkCompletedAdapter.MyViewHolder holder, int position) {
