...
public class WorkReAllocationDetailsActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private AppCompatSpinner selectAreaSpinner, mainPipelineSpinner, serviceLineSpinner,actionFormSpinner,selectEmployeeSpinner;
    ...
    private TextView reAllocateTextView, selectEmployeeLabel, complaintNumberTextView, consumerNoTextView, dateTimeTextView, consumerNameTextView, contactNoTextView,
            ...
            zoneTextView, subZoneTextView, priorityTextView, sourceTypeTextView, assignedEmployeeName,vipTextView,slaStatusTextView,repeatCallTextView,agingTextView;
    ...
    private String selectAreaStr, mainPipelineStr, serviceLineStr, boringChargesStr, securityDepositStr, newPipelineExpenditureStr, visitingChargesStr,
            ...
            reinforceTotalStr, waterFirstNumberStr, waterSecondNumberStr, waterTotalStr, totalAmountStr, complaintNoStr, consumerNoStr, dateTimeStr,registerDateTimeStr="",selectedEmpValue="",
            ...
            subZoneStr, disputeBillStr, priorityStr, sourceTypeStr, dateStr, timeStr, assignedCodeStr, assignedNameStr, employeeStr, timeFormat, AM_PM,vipName,com_seq="",complaintCode="";
    ...
    private Gson gson;
    private String jsonResponse = "",departmentID="",selectedEmpCode="",repeatCall="",agging="",sla="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_work_re_allocation_details);
     //   getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        ...
        if (actionBar != null) {
            actionBar.setTitle(getResources().getString(R.string.work_reallocation_detail));
        }

        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd-MMM-yyyy hh:mm:ss");
        dateTimeStr = simpleDateFormat.format(new Date());
        consumerNoStr = getIntent().getStringExtra("consumerNo");
        registerDateTimeStr = getIntent().getStringExtra("complaintDateTime");
      ...
      //  disputeBillTextView = findViewById(R.id.disputeBillTextView);
        ...
        dateTimeTextView.setText(registerDateTimeStr);
    ...
    private class ReallocateWork extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            try {
                ...
                ErrorClass.errorData(mCon, "WorkReAllocationDetailsActivity", "click reAllocateTextView", error);
            }
            progress.dismiss();
        }
    }
