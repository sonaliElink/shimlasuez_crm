...
import elink.suezShimla.water.crm.Complaint.Reallocation.Adapter.WorkReAllocationCompletionAdapter;
...
public class WorkReAllocationCompletionActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private WorkReAllocationCompletionAdapter workCompletionAdapter;
  ...
  //  private ArrayList<String> zoneList, subZoneList, complaintTypeList, complaintSubTypeList;
    ...
    String strConnSize="",strConnCategory="",complaintCode,complaintNoStr, consumerNoStr, complaintWorkAllocationDateStr, complaintDateTimeStr, complaintSubTypeStr, consumerNameStr, contactNoStr,
            complaintBy,addressStr, tariffStr, statusStr, priorityStr, zoneStr, zoneValueStr, subzone, subZoneStr, disputeBillMonthYrStr, zoneIdValueStr,
    ...
    String  sourceTypeIdStr="", originId="", customerTypeId="",serviceTypeStr="",originStr="",readerRemark="",srId="",fromDate="",toDate="",strClick="";;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_work_re_allocation_completion);
...
*/
    ...
    public void workAllocationBottomFilterDialog() {
        View sheetView = Objects.requireNonNull(getLayoutInflater().inflate(R.layout.bottom_sheet_work_re_allocation_completion_filter, null));
...
*/
    ...
    private void getWorkCompletionData() {
        ...
        param[8] = "ReAllocated";  //  test-data (1)
...
/* <Origin>string</Origin>
      <ServType>string</ServType>*/
                ...
                Log.e("datareallocation", Arrays.toString(paraNames));
                ...
                Log.e("reallocation",jsonResponse);
...
//                workCompletionModelList = new ArrayList<>();
                ...
                if (enums != null && enums.length > 0) {
                    for (WorkCompletionResponseModel model : enums) {
                       ...
                       /* List<String> latLongModelList = model.getSRM_LATITUDE();
                        ...
                        WorkCompletionResponseModel data = new WorkCompletionResponseModel(complaintCode,complaintNoStr, consumerNo, complaintWorkAllocationDateStr,
                                ...
                                meterTransIdStr, latStr, longStr,vipName,actionFormStr,repeatCall,agging,sla,comType,"","",originStr,readerRemark,complaintBy,strConnCategory,strConnSize);
                    ...
                    workCompletionAdapter = new WorkReAllocationCompletionAdapter(mCon, searchForStr,fromDate,toDate,strClick);
    ...
    private void getWorkCompletionDataWOFilter() {
        ...
        params[15] = "0";
        if (connection.isConnectingToInternet()) {
            Log.e("ComplaintWorkReAllocated",Arrays.toString(params));
