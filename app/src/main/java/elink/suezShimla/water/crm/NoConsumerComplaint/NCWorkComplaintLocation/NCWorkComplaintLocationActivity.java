package elink.suezShimla.water.crm.NoConsumerComplaint.NCWorkComplaintLocation;
...
public class NCWorkComplaintLocationActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    private Context mCon;
    private RecyclerView workCompletionRecyclerView;
    private SwipeRefreshLayout swipeRefreshLayout;
    private NCWorkComplaintLocationAdapter workComplaintLocationAdapter;
    private List<NCWorkComplaintLocationModel> workCompletionModelList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        workComplaintLocationAdapter = new NCWorkComplaintLocationAdapter(mCon);
