...
import elink.suezShimla.water.crm.Complaint.WorkCompletion.Adapter.WorkCompletedAdapter;
...
public class WorkCompletedActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private WorkCompletedAdapter workCompletionAdapter;
  ...
  //  private ArrayList<String> zoneList, subZoneList, complaintTypeList, complaintSubTypeList;
    ...
    String complaintCode,complaintNoStr, consumerNoStr, complaintWorkAllocationDateStr, complaintDateTimeStr, complaintSubTypeStr, consumerNameStr, contactNoStr,
    ...
    String  strConnCategory = "", strConnSize = "",sourceTypeIdStr="", originId="", customerTypeId="",serviceTypeStr="",originStr="",complaintBy="",readerRemark="",srId="",fromDate="",toDate="",strClick="";;
...
*/
    ...
    private void getWorkCompletionData() {
     ...
     /*   params = {String[17]@9775}
        ...
        Log.e("ComplaintWorkCompParams",Arrays.toString(param));
...
//                workCompletionModelList = new ArrayList<>();
                ...
                if (enums != null && enums.length > 0) {
                    ...
                    workCompletionAdapter = new WorkCompletedAdapter(mCon, searchForStr, fromDate, toDate, strClick);
