...
public class ComplaintRegisterModel {
    private List<ComplaintRegisterStringModel> data;
    ...
    public List<ComplaintRegisterStringModel> getData() {
        return data;
    }

    public void setData(List<ComplaintRegisterStringModel> data) {
        this.data = data;
    }
