...
public class NCWorkCompletionResponseModel {
    ...
    @SerializedName("FLM_ALLOCDATE")
    private String FLM_ALLOCDATE;
    ...
    public NCWorkCompletionResponseModel(){}


    public NCWorkCompletionResponseModel(String BUM_BU_NAME, String CIRCLE_NAME, String FLM_APP_NO, String FLM_APP_TCODE, String NAME, String CONSUMER_NAME, String FRM_REASONNAME, String FLM_APP_DATE, String FLM_SOURCE, String FLM_COMPTYPE, String REMARKS, String SRM_S_ADDRESS, String COMPFOR, String FLM_PHONE, String STATUS, String FCOMNO, String FLM_SERVICENUMBER,
                                       String TARIFF, String VIP, String SRM_BILL_AMOUNT,String SRM_BU_ID,String SRM_PC_ID,String FLM_ALLOCDATE,String PRIORITY) {
        ...
        this.FLM_ALLOCDATE = FLM_ALLOCDATE;
    ...
    public String getFLM_ALLOCDATE() {
        return FLM_ALLOCDATE;
    }

    public void setFLM_ALLOCDATE(String FLM_ALLOCDATE) {
        this.FLM_ALLOCDATE = FLM_ALLOCDATE;
    }
