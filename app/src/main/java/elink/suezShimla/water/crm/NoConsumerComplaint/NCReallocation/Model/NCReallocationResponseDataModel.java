...
public class NCReallocationResponseDataModel {
    ...
    public NCReallocationResponseDataModel() {
    }

    public NCReallocationResponseDataModel(String COMNO, String BUM_BU_NAME, String CIRCLE_NAME, String COM_COMPDATE, String CONSUMER_NAME, String ADDRESS_NO,
                                         String MOBILE, String CMTM_NAME, String OCRM_NAME, String COM_SERVICE_NO, String TARIFF, String STATUS,
                                         String COM_YEAR_BILL, String PRIORITY, String SOURCETYPE, String EMPCODE, String EMPNAME,String VIP) {
        this.COMNO = COMNO;
    ...
    public String toString() {
        return "NCReallocationResponseDataModel{" +
