...
public class WorkAllocateModel {
    ...
    public WorkAllocateModel(){}

    public WorkAllocateModel(String comSeq, String wConsumer, String wWadt, String empCode, String ipAddress, String remarks, String empId, String wComSeq, String complaintType, String complaintSubType) {
        this.comSeq = comSeq;
