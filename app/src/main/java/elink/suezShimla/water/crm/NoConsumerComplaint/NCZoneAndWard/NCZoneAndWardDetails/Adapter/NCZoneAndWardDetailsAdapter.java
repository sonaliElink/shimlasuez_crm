package elink.suezShimla.water.crm.NoConsumerComplaint.NCZoneAndWard.NCZoneAndWardDetails.Adapter;
...
import elink.suezShimla.water.crm.NoConsumerComplaint.NCZoneAndWard.NCZoneAndWardDetails.Model.NCZoneAndWardDetailsModel;
import elink.suezShimla.water.crm.R;

public class NCZoneAndWardDetailsAdapter extends RecyclerView.Adapter<NCZoneAndWardDetailsAdapter.MyViewHolder>{
    private Context mCon;
    private List<NCZoneAndWardDetailsModel> data;
    private LayoutInflater inflater;

    public NCZoneAndWardDetailsAdapter(Context context) {
        this.mCon = context;
        data = new ArrayList<>();
        inflater = LayoutInflater.from(mCon);
    }

    public void addList(List<NCZoneAndWardDetailsModel> list) {
        if (data != null) {
            clear();
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int i) {
        final NCZoneAndWardDetailsModel current = data.get(i);
