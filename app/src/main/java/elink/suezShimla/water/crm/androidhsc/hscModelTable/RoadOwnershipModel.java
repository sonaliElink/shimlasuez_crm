...
public class RoadOwnershipModel extends RealmObject {
    ...
    public RoadOwnershipModel(String ID, String REM_REASONNM) {
        this.ID = ID;
        this.REM_REASONNM = REM_REASONNM;
    }

    public RoadOwnershipModel() {
    }
