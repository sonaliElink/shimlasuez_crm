package elink.suezShimla.water.crm.NoConsumerComplaint.NCWorkCompletion;
...
import elink.suezShimla.water.crm.NoConsumerComplaint.NCWorkComplaintLocation.Adapter.NCWorkComplaintLocationAdapter;
import elink.suezShimla.water.crm.NoConsumerComplaint.NCWorkComplaintLocation.Model.NCWorkComplaintLocationModel;
import elink.suezShimla.water.crm.R;


public class NCWorkCompletionFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    private Context mCon;
    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView completionRecyclerView;
    private List<NCWorkComplaintLocationModel> ncworkCompletionModelList;
    private NCWorkComplaintLocationAdapter ncworkComplaintLocationAdapter;
    ...
    public NCWorkCompletionFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        ncworkComplaintLocationAdapter = new NCWorkComplaintLocationAdapter(mCon);
    ...
    private void allocationData() {
        ncworkCompletionModelList = new ArrayList<>();
        for (int i = 0; i < 10; i++) {
            NCWorkComplaintLocationModel workCompletionModel = new NCWorkComplaintLocationModel("WM/21/07/16/52 " + i, "PATEL JANTBI GAISUDIN " + i, "886616893" + i, "Flat No. " + i + " Triveni Apartments Pitam Pura NEW DELHI 110034 INDIA");
            ncworkCompletionModelList.add(workCompletionModel);
            ncworkComplaintLocationAdapter.addList(ncworkCompletionModelList);
            completionRecyclerView.setAdapter(ncworkComplaintLocationAdapter);
            ncworkComplaintLocationAdapter.notifyDataSetChanged();
        }
    }
