...
import elink.suezShimla.water.crm.Complaint.TodaysCompletedWork.Adapter.TodayWorkCompletedAdapter;
...
public class TodayWorkCompletedActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private TodayWorkCompletedAdapter workCompletionAdapter;
  ...
  //  private ArrayList<String> zoneList, subZoneList, complaintTypeList, complaintSubTypeList;
    ...
    String  strConnSize="",strConnCategory="",sourceTypeIdStr="", originId="", customerTypeId="",serviceTypeStr="",originStr="",complaintBy="",readerRemark="",srId="",fromDate="",toDate="",strClick="";;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_today_work_completed);
...
/* <Origin>string</Origin>
        ...
        protected void onPostExecute(Void aVoid) {
            try {
                ...
                if (enums != null && enums.length > 0) {
                    ...
                    workCompletionAdapter = new TodayWorkCompletedAdapter(mCon, searchForStr, fromDate, toDate, strClick);
    ...
    private void getWorkCompletionDataWOFilter() {
        ...
        params[15] = "0";
        if (connection.isConnectingToInternet()) {
            Log.e("TotalComplaintRecord",Arrays.toString(params));
            WorkCompletion workCompletion = new WorkCompletion();
