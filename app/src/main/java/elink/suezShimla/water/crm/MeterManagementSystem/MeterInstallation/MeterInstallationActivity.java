...
import elink.suezShimla.water.crm.MeterManagementSystem.MeterInstallation.Adapter.MeterInstallationAdapter;
...
public class MeterInstallationActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private MeterInstallationAdapter meterInstallationAdapter;
    ...
    private String requestTypeStr,  toDateStr="",zoneIdValueStr,zoneIdStr, subzoneIdValueStr, requestType="";
    private Calendar fromDateCalendar, toDateCalendar;
    RealmOperations realmOperations;
    int zoneId=0,subZoneId=0,requestId=0;
    String zoneName="",subZoneName="",requstType="",requestIdValueStr="0";
    ...
    String consumerNo="",consumerType="",reqNo="",serviceType="",phase="",oldMtrNo="",oldMtrTyp="", oldMtrReading="",
            ...
            sourceTypeValStr="",sourceTypeVal="",obserStr="",obserValStr="", cons_numStr="",fromDateStr="";
...
//        openSheetDialog();
        ...
        meterInstallationAdapter = new MeterInstallationAdapter(mCon, fromDateStr, toDateStr);
...
*/
    ...
    private void validate() {
        ...
        if (requestTypeStr.equalsIgnoreCase("All")) {
        ...
        if (zoneIdValueStr.equalsIgnoreCase("All")) {
        ...
        protected void onPostExecute(Void aVoid) {
            try {
                ...
                if(downloadShowMeterData.size() == 0){
                    ...
                    meterInstllRecyclerView.setVisibility(View.GONE);
...
*/
    ...
    private void getMeterInstallationList(){
        ...
        params[6] = "-1";
        params[7] = "608";
        Log.e("WorkAllocationParams", Arrays.toString(params));
