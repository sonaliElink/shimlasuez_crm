...
import elink.suezShimla.water.crm.MeterManagementSystem.MeterInstallation.Adapter.MeterInstallationAutheticatedAdapter;
...
public class MeterInstallationAutheticatedActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private MeterInstallationAutheticatedAdapter meterInstallationAdapter;
...
//                android.R.color.holo_orange_dark, android.R.color.holo_red_dark);
        ...
        meterInstallationAdapter = new MeterInstallationAutheticatedAdapter(mCon);
...
//    }
    ...
    private void getFilteredMeterInstallation(){
        ...
        params[1] = empcode;
        params[2] = cons_numStr;
        params[3] = fromDateStr;
        params[4] = toDateStr;
        params[5] = zoneIdStr;
        params[6] = String.valueOf(subZone_id);
        params[7] = "603";
