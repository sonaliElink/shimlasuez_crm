...
public class NCWorkAllocationDetailsActivity extends AppCompatActivity {
    ...
    private TextView allocateButton, selectEmployeeLabel, complaintNumberTextView, consumerNoTextView, dateTimeTextView, consumerNameTextView, contactNoTextView,
            ...
            subZoneTextView, disputeBillTextView, assignedEmployeeName,vipTextView,requestNumberTextView;
    ...
    private String remarkStr, dateStr, timeStr, selectAreaStr, mainPipelineStr, serviceLineStr, boringChargesStr, securityDepositStr, newPipelineExpenditureStr,
            ...
            dateTimeStr, consumerNameStr, contactNoStr, addressStr, complaintTypeStr, complaintSubTypeStr, workAllocationDateStr, tariffStr, statusStr,
            zoneStr, subZoneStr, disputeBillStr, timeFormat, AM_PM,vipname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ncwork_allocation_details);
   ...
   /*     timeEditText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(NCWorkAllocationDetailsActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
                        ...
                        if (selectedHour>=hour && selectedMinute>=minute){
                            ...
                            Toast.makeText(mCon,"Invalid time! Please Select greater than current time",Toast.LENGTH_LONG);
                        }
                    }
                }, hour, minute, true);//Yes 24 hour time
...
/*
        ...
        timeEditText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog tpd = new TimePickerDialog(NCWorkAllocationDetailsActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timePicker, int hourOfDay, int minute) {
                        ...
                        if(datetime.getTimeInMillis()>=calendar.getTimeInMillis()){
                            ...
                            Toast.makeText(NCWorkAllocationDetailsActivity.this,"Invalid Time", Toast.LENGTH_LONG).show();
...
*/
    ...
    private void validateAllocation() {
        ...
        if (isValidDate && isValidTime && isValidRemark) {
            ...
            if (setEmployeeRecyclerView.getVisibility() == View.VISIBLE) {
    ...
    private class AllocateWork extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            try {
                ...
                ErrorClass.errorData(mCon, "NCWorkAllocationDetails", "N_Complaint_WorkAllocation task", error);
            }
            progress.dismiss();
        }
    }
