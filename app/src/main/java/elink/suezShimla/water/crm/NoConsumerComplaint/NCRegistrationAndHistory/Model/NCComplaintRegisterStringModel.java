...
public class NCComplaintRegisterStringModel {
    ...
    public NCComplaintRegisterStringModel(){}

    public NCComplaintRegisterStringModel(String consumerNo, String consumerName, String mobileNo, String email, String wBillAmount, String wArrAmount, String cHardcore, String zoneId, String cHardcore2, String subzone, String status, String hdnTheft, String lblSAPPhase) {
    ...
    public String toString() {
        return "NCComplaintRegisterStringModel{" +
