...
public class DownloadMeterStatusBillAdjust {
    ...
    public DownloadMeterStatusBillAdjust() {
    }

    public DownloadMeterStatusBillAdjust(String MSM_METERSTATUS_ID, String MSM_METERSTATUS_NAME, String BILLEDID, String MSM_AVG_MONTHS, String MSM_AVG_METERSTATUS, String MSM_READING_MANDATORY, String MSM_PHOTO_REQ, String HIGH, String LOW) {
    ...
    public String toString() {
        return "DownloadMeterStatusBillAdjust{" +
