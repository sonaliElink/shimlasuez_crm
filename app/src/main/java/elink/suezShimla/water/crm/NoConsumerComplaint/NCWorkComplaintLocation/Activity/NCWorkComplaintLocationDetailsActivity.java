package elink.suezShimla.water.crm.NoConsumerComplaint.NCWorkComplaintLocation.Activity;
...
public class NCWorkComplaintLocationDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ncwork_complaint_location_details);
        mCon = this;
